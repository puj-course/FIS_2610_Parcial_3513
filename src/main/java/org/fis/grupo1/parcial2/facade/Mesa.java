...
public class Mesa {
    ...
    ArrayList <org.fis.grupo1.JuradoVotacion> jurados;
    int idMesa;

    public Mesa(ArrayList<String> votos, ArrayList<org.fis.grupo1.JuradoVotacion> jurados, int idMesa) {
        this.votos = votos;
    ...
    public ArrayList<org.fis.grupo1.JuradoVotacion> getJurados() {
        return jurados;
    }
